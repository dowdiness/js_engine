...
- After removing a blanket feature skip, update active intent docs and run `make validate-docs-skip-policy`. Graduated features live in `scripts/docs_skip_policy_manifest.json`.
