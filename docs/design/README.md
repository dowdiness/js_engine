...
- [runtime-state-ownership-audit-2026-06-25.md](runtime-state-ownership-audit-2026-06-25.md) — concrete runtime/stdlib mutable-state owner map for #245.
...
- [../decisions/bytecode-execution-representation-contract.md](../decisions/bytecode-execution-representation-contract.md) — accepted #601 decision: stack bytecode as the sole long-term compiled executable representation, verifier contract, and migration sequence.
