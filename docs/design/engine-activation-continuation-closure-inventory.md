...
|---|---|---|
| Public production | The exact #616 depth-256 programs (including the #790 retained-argument comma workload), exact direct numeric `call_value`, exact #809/#811/#813/#815/#817 ordinary direct-return recipes, admitted protected numeric completions, and the two exact protected-control roots pass through public adapters; #817 observes 513 ordinary activations (257 `f` plus 256 `id`) | General programs or callable families are stack-safe |
