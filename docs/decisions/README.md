...
- [engine-execution-guardrail-contract.md](engine-execution-guardrail-contract.md) — accepted operation-scoped guardrail contract; bounded evaluation and JSON-call slices are implemented, while bounded queue checkpoints and complete accounting remain pending.
