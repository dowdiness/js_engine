...
- [executor-neutral-function-activation-contract.md](executor-neutral-function-activation-contract.md) — runtime-owned function preparation with opaque executor code and private resumable frames; the sealed ordinary-function tree slice avoids host-recursive guest entry, while broader mixed bytecode/tree/native and dynamic-call safety remains downstream work.
