...
- [engine-execution-guardrail-contract.md](engine-execution-guardrail-contract.md) — accepted operation-scoped guardrail contract; bounded evaluation, JSON-call, and microtask-checkpoint slices are implemented, while the bounded timer checkpoint and complete accounting remain pending.
