...
- [bytecode-execution-representation-contract.md](bytecode-execution-representation-contract.md) — accepted bytecode execution representation contract for #601: deepen existing stack bytecode as the sole long-term compiled executable representation; reject separate ExecutionIR and register/basic-block alternatives.
