# Agent Task Queue History

> **Status:** ARCHIVED — historical task queue moved out of
> [../agent-todo.md](../agent-todo.md) on 2026-06-18 so the active queue can
> stay focused on unresolved work. Do not treat old counts or branch names below
> as current project status; verify against code, CI, and current docs.
...
All four stages shipped. See [archive/architecture-redesign-2026-04-15.md](architecture-redesign-2026-04-15.md) for the full analysis.
