...
console.log("\\n=== All tests completed ===");
`,W=Object.assign({"../generated/examples/arith.js":A,"../generated/examples/closure.js":C,"../generated/examples/factorial.js":H,"../generated/examples/fibonacci.js":L,"../generated/examples/fizzbuzz.js":M,"../generated/examples/gc.js":G,"../generated/examples/iterator.js":P,"../generated/examples/mandelbrot.js":R,"../generated/examples/prototype.js":D,"../generated/examples/test_map_set.js":$});function B(e){const n=e.split("/").pop();if(!n||!n.endsWith(".js"))throw new Error(`Invalid example path: ${e}`);return n.slice(0,-3)}const y=Object.fromEntries(Object.entries(W).map(([e,n])=>[B(e),n])),c=p(document.querySelector("#editor"),"editor"),u=p(document.querySelector("#console"),"console"),d=p(document.querySelector("#result"),"result"),m=p(document.querySelector("#diagnostics"),"diagnostics"),k=p(document.querySelector("#status"),"status");function p(e,n){if(!e)throw new Error(`Playground markup is missing ${n}`);return e}function x(){return c.value}function N(e){c.value=e}function U(){c.focus()}function F(e){e&&(c.focus(),c.setSelectionRange(e.start.offset,e.end?.offset??e.start.offset))}function K(){g("Running","running"),r(u,""),r(d,""),r(m,"")}function V(e,n){g("Complete","complete"),r(u,e.join(`
